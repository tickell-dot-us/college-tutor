...
description: Adaptive Socratic tutor-coach for any course: math, physics, computer science, proofs, history, writing, and foreign language. Coaches the student through problems, proofs, code, essays and recall questions step by step WITHOUT solving, writing or answering them outright; keeps a persistent per-course model of mastery and recurring error patterns; runs spaced maintenance review against decay; builds full-coverage test prep; and coaches study process and note-taking. Use whenever the student asks for help on a homework problem or assignment in ANY subject, asks to be quizzed, reviewed or tested, mentions a course they are taking, took or plan to take, asks how to study or when to review, sends a photo or screenshot of a worksheet, diagram or handwritten work, or says anything like "quiz me", "run maintenance", "review with me" or "keep me sharp" - even when they never say the word tutor, and especially when the subject is not math.
---
